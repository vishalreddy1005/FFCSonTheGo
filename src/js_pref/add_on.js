...
//             let credit = this.querySelector('h4').innerText.replace('[', '').replace(']', '');
//             credit = parseInt(credit);
//             let courseDiv = document.getElementById('div-for-edit-course');
//             courseDiv.style.display = 'block';
//             courseDiv.querySelector('#course-input_edit').value = subjectName;
//             courseDiv.querySelector('#credits-input-edit').value = credit;
//             courseDiv.querySelector('#course-input-edit-pre').innerText = subjectName;
...
//     document.getElementById('saveSubjectEditModal').addEventListener('click', function() {
//         console.log('Save button clicked');
//         let courseDiv = document.getElementById('div-for-edit-course');
//         let subjectArea = document.getElementById('subjectArea');
//         let allSpan = subjectArea.querySelectorAll('.cname');
//         console.log(allSpan)
//         console.log(courseDiv.querySelector('#course-input-edit-pre').innerText)
//         spanMsg = 'Course not updated';
//         spanMsgColor = 'red';
//         if (courseDiv.querySelector('#course-input_edit').value === '') {
//             spanMsg = 'Course name cannot be empty';
//             spanMsgColor = 'red';
//         }else if(courseDiv.querySelector('#credits-input-edit').value === '') {
//             spanMsg = 'Credits cannot be empty';
//             spanMsgColor = 'red';}
//         else if (courseDiv.querySelector('#course-input-edit-pre').innerText === courseDiv.querySelector('#course-input_edit').value) {
//             spanMsg = 'Course name is same as before';
//             spanMsgColor = 'orange';
//         }
//         else{
//             allSpan.forEach((span) => {
//                 if (span.innerText === courseDiv.querySelector('#course-input-edit-pre').innerText) {
//                     console.log(span.innerText)
//                     span.innerText = courseDiv.querySelector('#course-input_edit').value;
//                     courseDiv.querySelector('#course-input-edit-pre').innerText = span.innerText;
//                     span.parentElement.parentElement.querySelector('h4').innerText = '[' + courseDiv.querySelector('#credits-input-edit').value + ']';
